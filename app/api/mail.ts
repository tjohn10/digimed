...
export async function sendEmail(subject: string, html: string, text: string, replyTo?: string) {
  ...
  if (smtpHost && smtpUser && smtpPass) {
    ...
    console.log(`Email notification sent successfully to contact@ontimetherapy.com: ${subject}`);
  } else {
