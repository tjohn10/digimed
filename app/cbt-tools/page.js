...
import { PenTool, Info, Trash2, Calendar, BookOpen } from 'lucide-react';
...
export default function CBTToolsDashboard() {
    ...
    const handleSave = (e) => {
        ...
        // Reset HTML checkbox elements manually
        const formEl = document.getElementById('thought-record-form-el');
